...
@rem ##########################################################################
@rem
@rem  inspectacle-service startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and INSPECTACLE_SERVICE_OPTS to pass JVM options to this script.
...
:fail
rem Set variable INSPECTACLE_SERVICE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%INSPECTACLE_SERVICE_EXIT_CONSOLE%" exit 1
exit /b 1
